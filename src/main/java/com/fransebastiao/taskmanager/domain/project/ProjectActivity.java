...
public class ProjectActivity {
    ...
    public enum ActivityType {
        ...
        FILE_ADDED,       // marker--blue
        COMMENT_ADDED,    // marker--purple
        DEADLINE_UPDATED, // marker--amber
        TASK_ASSIGNED,
        MEMBER_ADDED,
        STATUS_CHANGED,
        PROGRESS_UPDATED
    ...
    public ProjectActivity(Project project, User user,
                            String text, ActivityType type) {
